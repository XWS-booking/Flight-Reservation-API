...
func (flightRepository *FlightRepository) GetFlightsForReservation(startDate time.Time, endDate time.Time, departure string, destination string) ([]Flight, error) {
	collection := flightRepository.getCollection("flights")
